...
<body>
	...
	<ul class="nav-links">
		...
		<li><a href="/Actividad/Administrador/Buscar/buscarAdmin.html">Buscar</a></li>
	</ul>
</nav>
	</header>
	<br><br><br><br><br><br>
				...
				if (array_key_exists("nombre", $fila)) {
					...
					foreach ($fila as $clave => $valor) {
							...
							echo "<form method='POST'>
									...
									<input type='hidden' name='id_peliculas' value='" . $fila['id_pelicula'] . "'>
									<input type='submit' name='eliminar' value='Eliminar'>
								  </form>";
							echo "</div>";
				}
